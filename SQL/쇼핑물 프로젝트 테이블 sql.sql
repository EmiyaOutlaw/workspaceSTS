...
INSERT INTO SUB_MENU VALUES('SUB_MENU_005', '구매 목록 관리', 'MENU_001', 'manageBuyList');

DELETE FROM SUB_MENU 
WHERE SUB_MENU_CODE = 'SUB_MENU_005';
...
-- 구매정보테이블
--주문날짜_주문자ID  -> 20220331120233_botw
...
SELECT to_char(buy_date, 'YYYY-MM-DD HH24:MI:SS')
FROM SHOP_BUY;
